...
|---|---|---|---|---|---|
| SRC-01 | `requirements/dac_ta_yeu_cau_luong_thuat_toan_va_use_case.docx` | Chủ dự án | 2026-09-18 | APPROVED | Đặc tả yêu cầu, use case, quy trình nghiệp vụ cốt lõi |
